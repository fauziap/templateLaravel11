                ...
                <form class="space-y-4 md:space-y-6" wire:submit='registerUser'>
                        ...
                        <div>
                            <div class="relative flex items-center">
                                ...
                                <input :type="showPassword ? 'text' : 'password'" name="password" id="password"
                                    placeholder="••••••••"
                                    class="bg-gray-50 focus:outline-none border  text-gray-900 @error('password') border-red-500 @enderror sm:text-sm rounded-lg focus:ring-gray-300 block w-full p-2.5 placeholder-gray-400"
                                    wire:model='password' required>
                                <span
                                    class="material-symbols-outlined no-select cursor-pointer absolute right-2 ml-2 focus:outline-none"
                    ...
                    <div class="pt-3">
                        ...
                        <div class="flex justify-center items-center mt-3">
                            <p class="font-normal text-sm">Sudah punya akun? <a href="{{ route('login') }}"
